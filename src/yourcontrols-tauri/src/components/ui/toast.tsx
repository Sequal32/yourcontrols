...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // "fixed top-0 z-[100] flex max-h-screen w-full p-4 left-1/2 -translate-x-1/2 sm:bottom-0 sm:top-auto md:max-w-max",
      // "fixed top-0 z-[100] flex max-h-screen w-full sm:flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto md:flex-col md:max-w-max",
      // "fixed z-[100] flex max-h-screen w-full p-4 bottom-0 right-0 top-auto max-w-max",
      "fixed z-[100] flex max-h-screen w-full p-4 top-0 left-1/2 -translate-x-1/2 max-w-max",
      className
    )}
    {...props}
  />
